...
<body>
	...
	<form action="<%= request.getContextPath()%>/serial/add.do" method="get">
			     ...
			     <section>
			      <ul class="ulColumn2">
			       <li>
			        ...
			        <select class="select" id="sele_brand_code"  name="brand_code" >
			         <option value="" >==请选择 ==</option>
			        </select>
			       </li>
			       <li>
			        <span class="item_name" style="width:120px;">车系编码：</span>
			        <input type="text" class="textbox textbox_295" name="serial_code" placeholder="车系编码..."/>
			       </li>
			       <li>
			        <span class="item_name" style="width:120px;">车系名称：</span>
			        <input type="text" class="textbox textbox_295" name="serial_name" placeholder="车系名称..."/>
			       </li>
			       <li>
