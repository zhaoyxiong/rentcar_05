...
<body>
	...
	<section class="rt_wrap content mCustomScrollbar">
		<form action="<%=request.getContextPath()%>/car/update.do" method="post">
			<div class="rt_content">
				<div class="page_title">
					<h2 class="fl">租赁车辆信息修改</h2>
				...
				<section>
					<ul class="ulColumn2">
						<li><span class="item_name" style="width: 120px;">公司名称：</span>
							<select class="select" name="lease_id">
								<c:forEach items="${companylist}" var="c">
									<c:choose>
										<c:when test="${car.lease_id==c.id }">
											<option selected="selected" value="${c.id}">${c.company_name}</option>
										</c:when>
										<c:otherwise>
						...
						<li><span class="item_name" style="width: 120px;">车辆编号：</span>
							...
							value=${car.car_no } placeholder="车辆编号..." /></li>
